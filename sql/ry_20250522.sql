...
work_hours       varchar(100)                               comment '工作时长 持续工作/1小时/2小时0x00  持续工作  0x01 工作1小时   0x02工作两小时',
buoy_type       varchar(100)                               comment '浮标类型 A型浮标/b型浮标0x00  A型浮标  0x01 B型浮标',
communication_method       varchar(100)                               comment '通讯方式 0x00  超短波   0x01 公开体制   0x02 模拟铱星',
upward_frequency       varchar(100)                               comment '上行频率',
down_frequency       varchar(100)                               comment '下行频率',
upward_power       varchar(100)                               comment '上行功率',
